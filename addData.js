...
async function main() {
    ...
    let geohash = web3.utils.utf8ToHex("6d1g1w");
    console.log("geoHash: " + geohash); //web3.fromAscii("6yh2f4")
    // const tx = await reg.methods.register("0x6dc6d99d42e7114a07e617391b2d0fbdc106bc03b6459a8558370ff9b3a2128e",
    //         "0x7423dff21c5e0eee9c555ecb5fa4759201ddc167060f0bd2d5034650e3e85566", now, now, 0, 33, geohash, 0, 0, symptoms)
    //     .call({
    //         form: account,
    //         gasPrice: 0
    //     });
